...
curl -v --cacert ca-root.crt --key curl-client.key --cert curl-client.crt  $https_mutual_route/flights/$place |jq
sleep 3
...
curl -s --cacert ca-root.crt --key curl-client.key --cert curl-client.crt  $https_mutual_route/hotels/$place |jq
sleep 3
...
curl -s --cacert ca-root.crt --key curl-client.key --cert curl-client.crt  $https_mutual_route/cars/$place |jq
sleep 3
...
curl -s --cacert ca-root.crt --key curl-client.key --cert curl-client.crt  $https_mutual_route/insurances/$place |jq
sleep 3
...
curl -s --cacert ca-root.crt --key curl-client.key --cert curl-client.crt  $https_mutual_route/travels/$place |jq
sleep 5