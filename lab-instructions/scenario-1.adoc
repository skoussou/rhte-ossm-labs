...
In this first lab scenario we’ll have a look at the requirements and considerations for the introduction of a Service Mesh as well as the involved personas from the fictive Travel Agency company.
