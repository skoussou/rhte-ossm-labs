...
[IMPORTANT]
====
As this is a multi-tenant cluster you should restrict use for this lab to the following namespaces associated with your user $LAB_PARTICIPANT_ID-prod-istio-system, $LAB_PARTICIPANT_ID-prod-travel-control, $LAB_PARTICIPANT_ID-prod-travel-portal
