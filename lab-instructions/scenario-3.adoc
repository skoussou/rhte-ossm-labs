...
+
image::assets/03-travel-agency-expected-3-container-pods.png[200,500]
...
+
image::assets/03-travel-control-expected-3-container-pods.png[200,500]

** `user-$LAB_PARTICIPANT_ID-prod-travel-portal`
+
image::assets/03-travel-portal-expected-3-container-pods.png[200,500]
