...
----
+
You can also login as `farid/farid` in the Openshift Console and verify the applications created in your `$LAB_PARTICIPANT_ID-prod-travel-agency` namespace (navigate to *`Administrator`* -> *`Workloads`* -> *`Pods`*). It should look like:
+
