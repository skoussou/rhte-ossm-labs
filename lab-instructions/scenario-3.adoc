...
Login as Mesh Operator (credentials `emma/emma`) and execute the following, at the end of the script use the URL to ensure the Travel Business Dashboard is now exposed via https.
